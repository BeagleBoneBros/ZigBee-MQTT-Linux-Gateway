...
/* SREQ/SRSP: */
#define MT_APP_CNF_SET_NWK_FRAME_COUNTER					0xFF //APP_CNF_SET_NWK_FRAME_COUNTER
#define MT_APP_CNF_SET_DEFAULT_REMOTE_ENDDEVICE_TIMEOUT		0x01 //APP_CNF_SET_DEFAULT_REMOTE_ENDDEVICE_TIMEOUT
#define MT_APP_CNF_SET_ENDDEVICETIMEOUT						0x02 //APP_CNF_SET_ENDDEVICETIMEOUT
#define MT_APP_CNF_SET_ALLOWREJOIN_TC_POLICY				0x03 //APP_CNF_SET_ALLOWREJOIN_TC_POLICY
#define MT_APP_CNF_ADD_INSTALLCODE							0x04 //APP_CNF_BDB_ADD_INSTALLCODE
#define MT_APP_CNF_START_COMMISSIONING	  					0x05 //APP_CNF_BDB_START_COMMISSIONING
#define MT_APP_CNF_SET_JOINUSESINSTALLCODEKEY 				0x06 //APP_CNF_BDB_SET_JOINUSESINSTALLCODEKEY
#define MT_APP_CNF_SET_ACTIVE_DEFAULT_CENTRALIZED_KEY   	0x07 //APP_CNF_BDB_SET_ACTIVE_DEFAULT_CENTRALIZED_KEY
#define MT_APP_CNF_SET_CHANNEL								0x08 //APP_CNF_BDB_SET_CHANNEL
#define MT_APP_CNF_SET_TC_REQUIRE_KEY_EXCHANGE				0x09 //APP_CNF_BDB_SET_TC_REQUIRE_KEY_EXCHANGE
#define MT_APP_CNF_ZED_ATTEMPT_RECOVER_NWK					0x0A //APP_CNF_BDB_ZED_ATTEMPT_RECOVER_NWK

#define MT_APP_CNF_COMMISSIONING_NOTIFICATION				0x80 //APP_CNF_BDB_COMMISIONING_NOTIFICATION
...
/***************************************************************************************************
 * APP CONFIG START_COMMISSIONING VALUES
 ***************************************************************************************************/

#define RESUME_OPERATION		0x00
#define TOUCHLINK				0x01
#define NETWORK_STEERING		0x02
#define NETWORK_FORMATION		0x04
#define FINDING_AND_BINDING		0x08
