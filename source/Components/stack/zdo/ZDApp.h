...
//Commissioning Modes
#define	MODE_INITIALIZATION  	0
#define	MODE_NWK_STEERING  		1
#define	MODE_FORMATION  		2
#define	MODE_FINDING_BINDING  	3
...
typedef enum {
  COMM_NOTI_SUCCESS = 0,
  COMM_NOTI_IN_PROGRESS = 1,
  COMM_NOTI_NO_NETWORK = 2,
  COMM_NOTI_TL_TARGET_FAILURE = 3,
  COMM_NOTI_TL_NOT_AA_CAPABLE = 4,
  COMM_NOTI_TL_NOT_SCAN_RESPONSE = 5,
  COMM_NOTI_TL_NOT_PERMITED = 6,
  COMM_NOTI_TCLK_EX_FAILURE = 7,
  COMM_NOTI_FORMATION_FAILURE = 8,
  COMM_NOTI_FB_TARGET_IN_PROGRESS = 9,
  COMM_NOTI_FB_INITIATOR_IN_PROGRESS = 10,
  COMM_NOTI_FB_NO_IDENTIFY_QUERY_RESPONSE = 11,
  COMM_NOTI_FB_BINDING_TABLE_FULL = 12,
  COMM_NOTI_NETWORK_RESTORED = 13,
  COMM_NOTI_FAILURE = 14,
} CommNotification_t;

typedef enum {
  COMM_MODE_INITIALIZATION = 0,
  COMM_MODE_NWK_STEERING = 1,
  COMM_MODE_FORMATION = 2,
  COMM_MODE_FINDING_BINDING = 3,
  COMM_MODE_TOUCHLINK = 4,
  COMM_MODE_PARENT_LOST = 5,
} CommMode_t;
