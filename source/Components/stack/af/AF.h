...
// The AppCnfCommNotiPacket_t structure is used to send the parameters of the incoming AppConfigBDBCommissioningNotification over an OSAL msg.
typedef struct
{
  osal_event_hdr_t hdr;    			/* OSAL Message header */
  uint8 status;           			/* Message's status Check Z-Stack Monitor and Test API page 139 */
  uint8 commissioningMode;          /* Message's commissioning mode Check Z-Stack Monitor and Test API page 139  */
  uint8 remainingCommMode;          /* Message's remaining commissioning mode Z-Stack Monitor and Test API page 139  */
} AppCnfCommNotiPacket_t;
