...
#define SAMPLE_APP_DEFAULT_TRACE_ENABLE_MASK (0xFFFFFFFF & ~MASK(trHELP))
...
int main(int argc, char **argv) 
{
	...
	default_trace_enable_mask = SAMPLE_APP_DEFAULT_TRACE_ENABLE_MASK;
	processUint32Flag("--verbose", "-v", &default_trace_enable_mask, &argc, argv);
	processUint32Flag("--log", "-l", &log_enable_mask, &argc, argv);
