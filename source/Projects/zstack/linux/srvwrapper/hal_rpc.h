...
#define RPC_SYS_APP_CNF		15   // BDB Interface APP CNF Commands subsystem
#define RPC_SYS_RESV16    	16
#define RPC_SYS_PROTOBUF  	17
#define RPC_SYS_SRV_CTRL	18   // Interface to control Server
#define RPC_SYS_MAX       	19   // Maximum value, must be last
