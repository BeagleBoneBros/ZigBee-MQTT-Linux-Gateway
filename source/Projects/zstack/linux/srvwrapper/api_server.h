...
typedef struct
{
  ...
  int layerNum; //layer number within the gateway middleware. 1 - npi, 2 - zstack, 3 - nwkmgr,  4 - gateway + ota, 5 - app
  char * serverName;
} apisSysParams_t;
 ...
 * @fn      appInitPhase2
 *
 * @brief   Called after the server wrapper parsed the command line args and config file.
 *
 * @param   none
 *
 * @return  0 if success, error code on failuer
 *
 *********************************************************************/
extern int appInitPhase2( void );

/*********************************************************************
 * @fn      appInitPhase3
 *
 * @brief   Called after the server wrapper connected to the server(s) at the lower layer.
 *
 ...
 *
 *********************************************************************/
extern int appInitPhase3( apicHandle_t *handles );

/*********************************************************************
 * @fn      appInitPhase4
 *
 * @brief   Called after the server wrapper opened the listening socket for client connections.
 *
 * @param   none
 *
 * @return  0 if success, error code on failuer
