...
typedef enum
{
  TYPE_UINT8 = 0, TYPE_UINT16 = 1, TYPE_UINT32 = 2, TYPE_STRING = 3, TYPE_INT8 = 4
} dataTypes_t;
...
typedef struct
{
  ...
  uint8_t size;         // The number of elements that go into the variable
} configTableItem_t;
 ...
 * @fn      parseConfigFile
 *
 * @brief   Function to parse a .ini configuration file, and set the 
 *          vaule of any keyword found that is in both the .ini file, 
 *          and the passed structure.
 *
 ...
 *              Looks for flagLong or flagShort following
