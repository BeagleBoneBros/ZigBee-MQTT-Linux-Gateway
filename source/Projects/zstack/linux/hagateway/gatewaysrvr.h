...
extern ZStatus_t gwGroupsClusterIndCB( zclGroupRsp_t *pRsp, uint8_t gwEndpointId );

ZStatus_t gwScenesClusterIndCB( zclSceneRsp_t *pRsp, uint8_t gwEndpointId );

extern ZStatus_t gwAlarmsClusterIndCB( zclAlarm_t *pAlarm, uint8_t gwEndpointId );

extern ZStatus_t gwZclPollControlCheckInCB( zclPollControlCheckIn_t *pCmd, uint8_t gwEndpointId );

extern ZStatus_t gwZclDoorLockRspCB( zclIncoming_t *pInMsg, uint8 status );

extern ZStatus_t gwSendGpSecRsp( gp_SecRsp_t *pGpSecRsp );

extern void gwGetDevNwkInfo( nwkIB_t *pNib );

extern void gwSetDevNwkInfo( nwkIB_t *pNib );
