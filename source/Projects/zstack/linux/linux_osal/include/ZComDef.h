...
#define APP_CNF_COMM_NOTIFICATION 0x40	  // APP CONFIG BDB COMMISSIONING NOTIFICATION

#define GP_INCOMING_SEC_RSP_CMD       0x50    // Incoming Security Response from Green Power stub
#define GP_INCOMING_DATA_IND_CMD      0x51    // Incoming Data Indication from Green Power stub
