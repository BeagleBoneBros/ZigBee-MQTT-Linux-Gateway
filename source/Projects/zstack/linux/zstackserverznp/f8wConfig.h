...
/* Set to 0 for no security, otherwise non-0 */
  ...
  #define DEFAULT_CHANLIST 0x04000000  // 11 - 0x0B
#endif
...
/* Define the flag for the Trust Center Link Key
 *
 * BDB_DEFAULT_TC_REQUIRE_KEY_EXCHANGE is set to 1 to make the exchange mandatory
 * and it's set to 0 when the exchange is not mandatory.
 */
#if !defined(BDB_DEFAULT_TC_REQUIRE_KEY_EXCHANGE)
  #define BDB_DEFAULT_TC_REQUIRE_KEY_EXCHANGE 1
#endif

/* Define the flag for the use of Install Code
 *
 * BDB_DEFAULT_JOIN_USES_INSTALL_CODE_KEY is set to 1 to make the use of IC mandatory
 * and it's set to 0 when it's not mandatory.
 */
#if !defined(BDB_DEFAULT_JOIN_USES_INSTALL_CODE_KEY)
  #define BDB_DEFAULT_JOIN_USES_INSTALL_CODE_KEY 0
#endif

/* Define the parameter for the EndDevice Timeout
 *
 * BDB_DEFAULT_REMOTE_ENDDEVICE_TIMEOUT is set to the value of the desired timeout.
 */
#if !defined(BDB_DEFAULT_REMOTE_ENDDEVICE_TIMEOUT)
  #define BDB_DEFAULT_REMOTE_ENDDEVICE_TIMEOUT 0x08
#endif
